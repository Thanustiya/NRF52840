...
Purpose : Demonstrates starting a simple Telnet like server with
          IPv4/IPv6 as available. This sample is a legacy duplicate
          of IP_SimpleServer.c .
...
//
// Include and configure the Telnet server main sample.
//
#include "IP_SimpleServer.c"
