...
*    This might not be necessary for all interfaces but is the default
...
*
*    If the toolchain provides an output routine for strings, this
*    shall be used instead of a character by character output as
*    this typically speeds up things by allowing transferring more
*    than a single at once. If nothing else is available an output
*    character by character using putchar() can be used.
*/
