...
**********************************************************************
----------------------------------------------------------------------
Purpose : Configuration file for embOS/IP via USB NCM.
...
#define _USB_PRODUCT_ID    0x3005
#define _USB_VENDOR_NAME   "SEGGER"
#define _USB_PRODUCT_NAME  "SEGGER NCM device"
...
*    Adds and configures NCM communication device class to USB stack.
*/
