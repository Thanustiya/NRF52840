...
**********************************************************************
----------------------------------------------------------------------
Purpose     : Configuration file for emNet via USB RNDIS.

              The Remote Network Driver Interface Specification (RNDIS)
              is a Microsoft USB class protocol which can be used to
              ...
              This configuration enables NetBIOS, which allows
              the user to reach the target via a plain text name.
              Notes:
                (1): This configuration file does not apply any MAC
                     addresses to the interfaces.
                     These interfaces are TARGET - emNet interface
                     and the HOST - RNDIS network card
                     The MAC addresses are automatically generated
...
#define _USB_PRODUCT_ID            0x3000
#define _USB_VENDOR_NAME           "SEGGER"
#define _USB_PRODUCT_NAME          "SEGGER RNDIS device"
...
#define _USB_RNDIS_VENDOR_ID       0x0022C7     // 24-bit Organizationally Unique Identifier (OUI) of the vendor.
                                                ...
                                                // a HW (MAC) address.
#define _USB_RNDIS_DESCRIPTION     "SEGGER RNDIS device"
...
*    Adds and configures RNDIS communication device class to USB stack.
*    See Notes(1).
*/
...
static int _Connect(unsigned IFaceId) {
  ...
  USBD_RNDIS_SetDeviceInfo(&_RNDIS_DeviceInfo);
  //
