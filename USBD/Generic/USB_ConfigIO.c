...
**********************************************************************
----------------------------------------------------------------------
Purpose     : Sample implementation of log and warn I/O routines
              for emUSB-Device.
-------------------------- END-OF-HEADER -----------------------------
*/
...
*    Output a debug message string (without additional new-line character).
*    This should be configured depending on the features of the development environment.
*
*  Parameters
...
#else
  //
  // if semihosting fputs() is not available, we can fall back to use putchar().
  //
  char c;
